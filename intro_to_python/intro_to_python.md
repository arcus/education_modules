...
<a href = "https://binder.pangeo.io/v2/gh/arcus/education_r25_notebooks/main?filepath=python_notebooks%2Fintro-to-python.ipynb" target = "_blank"> <img src = "https://binder.pangeo.io/badge_logo.svg"></a> **← Click the "launch binder" button!**
...
![An example of Python code in the Terminal with the code 7 + 8 and print("Hello World!")](images/python-interactive.png?raw=true)
</div>
...
<div style = "margin: 1rem; width: 750;">
![An example of Python code written in Spyder with the code name=input("What is your name?") and print("Welcome to Intro to Python, "+name+"!")](images/python-in-spyder.png?raw=true)
</div>
...
<div style = "margin: 1rem; width: 750;">
![The output of Python code in the Spyder console](images/python-spyder-console.png?raw=true)
</div>
...
<div style = "margin: 1rem; width: 750;">
![Anaconda Navigator interface](images/anaconda.png?raw=true)
</div>
