...
![Table 1 from the published paper on the cytomegalovirus data. Columns are "1 to 4 aKIRs", "5 to 6 aKIRs" and "P value". There are rows for each of the following variables: age, sex, race, diagnosis category, months from diagnosis to treatment, prior radiation therapy, number of prior chemo regimens, prior transplants, recipient CMV seropositive, donor CMV seropositive, and recipient or donor CMV seropositive.](http://www.ectrx.org/forms/displayimg.php?image_type=big&source=2011-02/v009i01p007-002.png)
...
<img src="media/table1_1.png" alt="First draft of Table 1 of the cytomegalovirus data, as generated by gtsummary." width="50%">
...
<img src="media/table1_2.png" alt="Table 1 again, but with a column added for p values." width="50%">
...
<img src="media/table1_3.png" alt="Table 1 again, but updated values for the p-value column that now match the published table." width="50%">
...
<img src="media/table1_4.png" alt="Table 1 with cleaned up row labels." width="50%">
