...
df.loc["bash_103_combining_commands", "collection"] = "learn_to_code"
...
df.loc["bash_command_line_101", "version"] = "1.5.3"
...
df.loc["bash_command_line_101", "collection"] = "learn_to_code"
...
df.loc["bash_command_line_102", "version"] = "1.2.2"
...
df.loc["bash_command_line_102", "collection"] = "learn_to_code"
...
df.loc["bash_conditionals_loops", "version"] = "1.2.2"
...
df.loc["bash_conditionals_loops", "collection"] = "learn_to_code"
...
df.loc["bash_scripts", "version"] = "1.3.1"
df.loc["bash_scripts", "current_version_description"] = "Added webinar links to additional resources"
...
df.loc["bash_scripts", "collection"] = "learn_to_code"
...
df.loc["bias_variance_tradeoff", "collection"] = "machine_learning, statistics"
df.loc["bias_variance_tradeoff", "coding_required"] = "false"
...
df.loc["citizen_science", "version"] = "1.0.4"
...
df.loc["citizen_science", "collection"] = "intro_to_data_science"
df.loc["citizen_science", "coding_required"] = "false"
...
df.loc["data_management_basics", "version"] = "1.1.1"
...
df.loc["data_management_basics", "collection"] = "intro_to_data_science"
...
df.loc["data_management_basics", "version_history"] = "&Previous versions: &&* [1.0.1](https://liascript.github.io/course/?https://raw.githubusercontent/arcus/education_modules/3cdfc807be26db43d837de9e325b66c9213a3d5c/data_management_basics/data_management_basics.md):  First version with improved feedback survey&" 
df.loc["data_storage_models", "author"] = "Nicole Feldman"
df.loc["data_storage_models", "email"] = "feldmanna@chop.edu"
df.loc["data_storage_models", "version"] = "1.1.4"
df.loc["data_storage_models", "current_version_description"] = "Updated quiz questions and metadata."
df.loc["data_storage_models", "module_type"] = "standard"
df.loc["data_storage_models", "docs_version"] = "2.0.0"
df.loc["data_storage_models", "language"] = "en"
df.loc["data_storage_models", "narrator"] = "UK English Female"
df.loc["data_storage_models", "mode"] = "Textbook"
df.loc["data_storage_models", "title"] = "Types of Data Storage Models"
df.loc["data_storage_models", "estimated_time_in_minutes"] = "30"
df.loc["data_storage_models", "module_type"] = "standard"
df.loc["data_storage_models", "good_first_module"] = "false"
df.loc["data_storage_models", "data_domain"] = ""
df.loc["data_storage_models", "data_task"] = "data_management"
df.loc["data_storage_models", "collection"] = "infrastructure_and_technology"
df.loc["data_storage_models", "coding_required"] = "false"
...
df.loc["data_storage_models", "pre_reqs"] = "None, this module is intended for all end users regardless of their technical skill set and computing set up. This module is the first in a series on data storage topics. It can be paired with a more technical and advanced module on security, privacy, and backup considerations for the data storage types discussed herein.&" 
...
df.loc["data_storage_models", "sets_you_up_for"] = "&" 
df.loc["data_storage_models", "depends_on_knowledge_available_in"] = "&" 
df.loc["data_storage_models", "version_history"] = "[1.0.0](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/7bbdf70c88a08b47a3740d2facf84b5ecdea57c6/data_storage_models/data_storage_models.md): Initial Version.&" 
df.loc["data_visualization_in_ggplot2", "author"] = "Rose Hartman"
df.loc["data_visualization_in_ggplot2", "email"] = "hartmanr1@chop.edu"
df.loc["data_visualization_in_ggplot2", "version"] = "1.4.4"
...
df.loc["data_visualization_in_ggplot2", "docs_version"] = "2.0.0"
...
df.loc["data_visualization_in_ggplot2", "collection"] = "learn_to_code"
...
df.loc["data_visualization_in_open_source_software", "version"] = "1.2.1"
...
df.loc["data_visualization_in_open_source_software", "mode"] = "Textbook"
...
df.loc["data_visualization_in_open_source_software", "collection"] = ""
...
df.loc["data_visualization_in_seaborn", "version"] = "1.2.3"
...
df.loc["data_visualization_in_seaborn", "collection"] = "learn_to_code"
...
df.loc["database_normalization", "version"] = "1.0.6"
df.loc["database_normalization", "current_version_description"] = "Initial Version."
df.loc["database_normalization", "module_type"] = "standard"
df.loc["database_normalization", "docs_version"] = "2.0.0"
df.loc["database_normalization", "language"] = "en"
df.loc["database_normalization", "narrator"] = "US English Female"
df.loc["database_normalization", "mode"] = "Textbook"
df.loc["database_normalization", "title"] = "Database Normalization"
df.loc["database_normalization", "estimated_time_in_minutes"] = "40"
df.loc["database_normalization", "module_type"] = "standard"
df.loc["database_normalization", "good_first_module"] = "false"
df.loc["database_normalization", "data_domain"] = "ehr"
df.loc["database_normalization", "data_task"] = "data_management"
df.loc["database_normalization", "collection"] = ""
df.loc["database_normalization", "coding_required"] = "false"
...
df.loc["database_normalization", "pre_reqs"] = "Learners should have experience working with data in tables.  This could included working with .csv files, SQL databases, R data frames, REDCap instruments, or other ways that data can be collected in tables. &" 
...
df.loc["database_normalization", "sets_you_up_for"] = "- sql_joins&" 
df.loc["database_normalization", "depends_on_knowledge_available_in"] = "&" 
df.loc["database_normalization", "version_history"] = "No previous versions.&" 
df.loc["demystifying_containers", "author"] = "Meredith Lee"
df.loc["demystifying_containers", "email"] = "leemc@chop.edu"
df.loc["demystifying_containers", "version"] = "1.0.2"
...
df.loc["demystifying_containers", "collection"] = "demystifying"
df.loc["demystifying_containers", "coding_required"] = "false"
...
df.loc["demystifying_geospatial_data", "version"] = "1.2.0"
df.loc["demystifying_geospatial_data", "current_version_description"] = "Improve hyperlink accessibility"
...
df.loc["demystifying_geospatial_data", "collection"] = "demystifying"
df.loc["demystifying_geospatial_data", "coding_required"] = "false"
...
df.loc["demystifying_large_language_models", "version"] = "1.0.4"
...
df.loc["demystifying_large_language_models", "docs_version"] = "2.0.0"
...
df.loc["demystifying_large_language_models", "module_type"] = "standard"
df.loc["demystifying_large_language_models", "good_first_module"] = "true"
df.loc["demystifying_large_language_models", "data_domain"] = "text"
df.loc["demystifying_large_language_models", "data_task"] = ""
df.loc["demystifying_large_language_models", "collection"] = "demystifying, machine_learning "
df.loc["demystifying_large_language_models", "coding_required"] = "false"
...
df.loc["demystifying_machine_learning", "version"] = "1.0.1"
...
df.loc["demystifying_machine_learning", "collection"] = "demystifying, machine_learning"
df.loc["demystifying_machine_learning", "coding_required"] = "false"
...
df.loc["demystifying_python", "version"] = "1.2.4"
df.loc["demystifying_python", "current_version_description"] = "Updated highlight boxes and metadata"
df.loc["demystifying_python", "module_type"] = "standard"
df.loc["demystifying_python", "docs_version"] = "2.0.0"
df.loc["demystifying_python", "language"] = "en"
df.loc["demystifying_python", "narrator"] = "UK English Female"
df.loc["demystifying_python", "mode"] = "Textbook"
df.loc["demystifying_python", "title"] = "Demystifying Python"
df.loc["demystifying_python", "estimated_time_in_minutes"] = "20"
df.loc["demystifying_python", "module_type"] = "standard"
df.loc["demystifying_python", "good_first_module"] = "false"
df.loc["demystifying_python", "data_domain"] = ""
df.loc["demystifying_python", "data_task"] = ""
df.loc["demystifying_python", "collection"] = "demystifying"
df.loc["demystifying_python", "coding_required"] = "false"
df.loc["demystifying_python", "coding_level"] = ""
df.loc["demystifying_python", "coding_language"] = "python"
...
df.loc["demystifying_python", "pre_reqs"] = "Learners should be familiar with tabular data (data stored in a rectangular format, like an Excel spreadsheet or a comma separated file). It is helpful to have some familiarity with [navigating to specific directories](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/main/bash_command_line_101/bash_command_line_101.md#1) and running programs in the Command Line/Terminal. Learners do not need to have access to Python or Jupyter notebooks on their own computers.&" 
...
df.loc["demystifying_python", "sets_you_up_for"] = "- python_basics_variables_functions&" 
df.loc["demystifying_python", "depends_on_knowledge_available_in"] = "- bash_command_line_101&" 
df.loc["demystifying_python", "version_history"] = "&Previous versions: &&- [1.1.0](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/6f4ca2c54c2fc72a33e5319b20a2ac50562b9ea6/demystifying_python/demystifying_python.md): Removed references to Atom, now sunsetted.&- [1.0.2](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/466799a081d2cb74d155dc0a26951d3492b81f8c/demystifying_python/demystifying_python.md): Initial Version.&&&" 
df.loc["demystifying_regular_expressions", "author"] = "Joy Payton"
df.loc["demystifying_regular_expressions", "email"] = "paytonk@chop.edu"
df.loc["demystifying_regular_expressions", "version"] = "1.0.2"
...
df.loc["demystifying_regular_expressions", "data_domain"] = "text"
df.loc["demystifying_regular_expressions", "data_task"] = ""
df.loc["demystifying_regular_expressions", "collection"] = "demystifying"
...
df.loc["demystifying_sql", "version"] = "1.2.2"
...
df.loc["demystifying_sql", "data_domain"] = "ehr"
df.loc["demystifying_sql", "data_task"] = ""
df.loc["demystifying_sql", "collection"] = "demystifying"
...
df.loc["directories_and_file_paths", "version"] = "1.3.6"
...
df.loc["directories_and_file_paths", "collection"] = "infrastructure_and_technology"
df.loc["directories_and_file_paths", "coding_required"] = "false"
...
df.loc["docker_101", "collection"] = "infrastructure_and_technology"
...
df.loc["elements_of_maps", "collection"] = ""
...
df.loc["genomics_quality_control", "version"] = "1.1.2"
...
df.loc["genomics_quality_control", "collection"] = ""
...
df.loc["genomics_setup", "version"] = "1.2.0"
df.loc["genomics_setup", "current_version_description"] = "Updated link to the Data Carpentries instructions, which changed after an update to their website. "
...
df.loc["genomics_setup", "collection"] = "infrastructure_and_technology"
...
df.loc["geocode_lat_long", "collection"] = ""
...
df.loc["git_history_of_project", "collection"] = ""
...
df.loc["git_setup_mac_and_linux", "version"] = "1.2.1"
...
df.loc["git_setup_mac_and_linux", "collection"] = "infrastructure_and_technology"
...
df.loc["git_setup_windows", "collection"] = "infrastructure_and_technology"
...
df.loc["how_to_troubleshoot", "pre_reqs"] = "This module assumes that learners have started using technical methods such as writing code.  However, this module is useful for learners at any stage of their technical journey, and is not specific to any particular methods or programming languages. &" 
...
df.loc["how_to_troubleshoot", "sets_you_up_for"] = "&" 
df.loc["how_to_troubleshoot", "depends_on_knowledge_available_in"] = "&" 
df.loc["how_to_troubleshoot", "version_history"] = "&Previous versions: &&- [1.0.0](https://raw.githubusercontent.com/arcus/education_modules/b3f308648906379648df742bd4d7349ca369cfaa/how_to_troubleshoot/how_to_troubleshoot.md): Initial version&" 
df.loc["intro_to_nhst", "author"] = "Rose Hartman"
df.loc["intro_to_nhst", "email"] = "hartmanr1@chop.edu"
df.loc["intro_to_nhst", "version"] = "1.0.2"
...
df.loc["intro_to_nhst", "collection"] = "statistics"
...
df.loc["learning_to_learn", "version"] = "1.1.1"
...
df.loc["learning_to_learn", "module_type"] = "standard"
df.loc["learning_to_learn", "good_first_module"] = "true"
df.loc["learning_to_learn", "data_domain"] = ""
df.loc["learning_to_learn", "data_task"] = ""
df.loc["learning_to_learn", "collection"] = "intro_to_data_science"
...
df.loc["learning_to_learn", "version_history"] = "Previous versions:&&- [1.0.3](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/a4ea7a7f1f9264dabe952b68941fc9f0f656c9fc/learning_to_learn/learning_to_learn.md): Initial version.&" 
df.loc["omics_orientation", "author"] = "Meredith Lee"
df.loc["omics_orientation", "email"] = "leemc@chop.edu"
df.loc["omics_orientation", "version"] = "1.1.4"
df.loc["omics_orientation", "current_version_description"] = "Update formatting for highlight boxes, fix typos, update front matter."
df.loc["omics_orientation", "module_type"] = "standard"
df.loc["omics_orientation", "docs_version"] = "2.0.0"
df.loc["omics_orientation", "language"] = "en"
df.loc["omics_orientation", "narrator"] = "UK English Female"
df.loc["omics_orientation", "mode"] = "Textbook"
df.loc["omics_orientation", "title"] = "Omics Orientation"
df.loc["omics_orientation", "estimated_time_in_minutes"] = "15"
df.loc["omics_orientation", "module_type"] = "standard"
df.loc["omics_orientation", "good_first_module"] = "true"
df.loc["omics_orientation", "data_domain"] = "omics"
df.loc["omics_orientation", "data_task"] = ""
df.loc["omics_orientation", "collection"] = "demystifying"
df.loc["omics_orientation", "coding_required"] = "false"
...
df.loc["omics_orientation", "pre_reqs"] = "None.&" 
...
df.loc["omics_orientation", "sets_you_up_for"] = "- genomics_setup&- genomics_quality_control&" 
df.loc["omics_orientation", "depends_on_knowledge_available_in"] = "&" 
df.loc["omics_orientation", "version_history"] = "Previous versions:&&- [1.0.1](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/914714acfb6b30980e011ab09e087d4d2c5c918e/omics_orientation/omics_orientation.md#1): Initial version.&" 
df.loc["pandas_transform", "author"] = "Elizabeth Drellich"
df.loc["pandas_transform", "email"] = "drelliche@chop.edu"
df.loc["pandas_transform", "version"] = "1.1.4"
...
df.loc["pandas_transform", "collection"] = "learn_to_code"
...
df.loc["python_basics_exercise", "version"] = "1.0.1"
...
df.loc["python_basics_exercise", "collection"] = "learn_to_code"
...
df.loc["python_basics_lists_dictionaries", "collection"] = "learn_to_code"
...
df.loc["python_basics_lists_dictionaries", "version_history"] = "Previous versions: &&[1.0.1](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/279f48bab219dd4622888a6301b7ca5b48880370/python_basics_lists_dictionaries/python_basics_lists_dictionaries.md#1): Initial version&" 
df.loc["python_basics_loops_conditionals", "author"] = "Meredith Lee"
df.loc["python_basics_loops_conditionals", "email"] = "leemc@chop.edu"
df.loc["python_basics_loops_conditionals", "version"] = "1.0.1"
...
df.loc["python_basics_loops_conditionals", "collection"] = "learn_to_code"
...
df.loc["python_basics_variables_functions_methods", "version"] = "1.0.1"
...
df.loc["python_basics_variables_functions_methods", "collection"] = "learn_to_code"
...
df.loc["python_practice", "version"] = "1.0.4"
...
df.loc["python_practice", "collection"] = "learn_to_code"
...
df.loc["r_basics_introduction", "version"] = "1.4.1"
...
df.loc["r_basics_introduction", "data_task"] = ""
df.loc["r_basics_introduction", "collection"] = "infrastructure_and_technology, learn_to_code, intro_to_data_science"
...
df.loc["r_basics_transform_data", "version"] = "1.3.3"
...
df.loc["r_basics_transform_data", "collection"] = "learn_to_code"
...
df.loc["r_basics_visualize_data", "version"] = "1.3.3"
...
df.loc["r_basics_visualize_data", "collection"] = "learn_to_code"
...
df.loc["r_missing_values", "version"] = "1.2.2"
...
df.loc["r_missing_values", "collection"] = "learn_to_code"
...
df.loc["r_practice", "version"] = "1.0.5"
...
df.loc["r_practice", "collection"] = "learn_to_code"
...
df.loc["r_reshape_long_wide", "version"] = "1.2.3"
...
df.loc["r_reshape_long_wide", "collection"] = "learn_to_code"
...
df.loc["r_summary_stats", "collection"] = "learn_to_code, statistics"
...
df.loc["regular_expressions_basics", "version"] = "1.0.1"
...
df.loc["regular_expressions_basics", "data_domain"] = "text"
df.loc["regular_expressions_basics", "data_task"] = ""
df.loc["regular_expressions_basics", "collection"] = "learn_to_code"
...
df.loc["regular_expressions_boundaries_anchors", "version"] = "1.0.2"
...
df.loc["regular_expressions_boundaries_anchors", "data_domain"] = "text"
df.loc["regular_expressions_boundaries_anchors", "data_task"] = ""
df.loc["regular_expressions_boundaries_anchors", "collection"] = "learn_to_code"
...
df.loc["regular_expressions_groups", "version"] = "1.0.1"
...
df.loc["regular_expressions_groups", "data_domain"] = "text"
df.loc["regular_expressions_groups", "data_task"] = ""
df.loc["regular_expressions_groups", "collection"] = "learn_to_code"
...
df.loc["regular_expressions_lookaheads", "version"] = "1.0.2"
...
df.loc["regular_expressions_lookaheads", "data_domain"] = "text"
df.loc["regular_expressions_lookaheads", "data_task"] = ""
df.loc["regular_expressions_lookaheads", "collection"] = "learn_to_code"
...
df.loc["reproducibility", "version"] = "1.5.2"
...
df.loc["reproducibility", "collection"] = "intro_to_data_science"
...
df.loc["sql_basics", "author"] = "Peter Camacho; Joy Payton"
df.loc["sql_basics", "email"] = "camachop@chop.edu; paytonk@chop.edu"
df.loc["sql_basics", "version"] = "1.2.0"
df.loc["sql_basics", "current_version_description"] = "Improve large table display with collapsible sections"
df.loc["sql_basics", "module_type"] = "standard"
df.loc["sql_basics", "docs_version"] = "3.0.0"
df.loc["sql_basics", "language"] = "en"
df.loc["sql_basics", "narrator"] = "US English Male"
df.loc["sql_basics", "mode"] = "Textbook"
df.loc["sql_basics", "title"] = "SQL Basics"
df.loc["sql_basics", "estimated_time_in_minutes"] = "60"
df.loc["sql_basics", "module_type"] = "standard"
df.loc["sql_basics", "good_first_module"] = "false"
df.loc["sql_basics", "data_domain"] = "ehr"
df.loc["sql_basics", "data_task"] = "data_wrangling"
df.loc["sql_basics", "collection"] = "learn_to_code"
...
df.loc["sql_intermediate", "data_domain"] = "ehr"
df.loc["sql_intermediate", "data_task"] = "data_wrangling"
df.loc["sql_intermediate", "collection"] = "learn_to_code"
...
df.loc["sql_joins", "version"] = "1.1.3"
...
df.loc["sql_joins", "data_domain"] = "ehr"
df.loc["sql_joins", "data_task"] = "data_wrangling"
df.loc["sql_joins", "collection"] = "learn_to_code"
...
df.loc["statistical_tests", "version"] = "1.3.4"
...
df.loc["statistical_tests", "collection"] = "statistics"
...
df.loc["tidy_data", "version"] = "1.1.6"
...
df.loc["tidy_data", "collection"] = "intro_to_data_science, demystifying"
df.loc["tidy_data", "coding_required"] = "false"
...
df.loc["using_redcap_api", "version"] = "2.0.2"
df.loc["using_redcap_api", "current_version_description"] = "Adds instructions for avoiding pushing API token to GitHub, adds information about environment variables, updates highlight boxes, and clarifies text editors"
df.loc["using_redcap_api", "module_type"] = "standard "
df.loc["using_redcap_api", "docs_version"] = "3.0.0"
df.loc["using_redcap_api", "language"] = "en"
df.loc["using_redcap_api", "narrator"] = "US English Female"
df.loc["using_redcap_api", "mode"] = "textbook"
df.loc["using_redcap_api", "title"] = "Using the REDCap API"
df.loc["using_redcap_api", "estimated_time_in_minutes"] = "60"
df.loc["using_redcap_api", "module_type"] = "standard "
df.loc["using_redcap_api", "good_first_module"] = "false"
df.loc["using_redcap_api", "data_domain"] = ""
df.loc["using_redcap_api", "data_task"] = ""
df.loc["using_redcap_api", "collection"] = "infrastructure_and_technology"
df.loc["using_redcap_api", "coding_required"] = "true"
df.loc["using_redcap_api", "coding_level"] = "intermediate"
df.loc["using_redcap_api", "coding_language"] = "r, python"
...
df.loc["using_redcap_api", "sets_you_up_for"] = "&" 
df.loc["using_redcap_api", "depends_on_knowledge_available_in"] = "&" 
df.loc["using_redcap_api", "version_history"] = "[1.0.2](https://liascript.github.io/course/?https://raw.githubusercontent.com/arcus/education_modules/a4ea7a7f1f9264dabe952b68941fc9f0f656c9fc/using_redcap_api/using_redcap_api.md#1): make it clear that you need to have R or Python installed&" 
...
a.append("genomics_quality_control")
a.append("genomics_setup")
