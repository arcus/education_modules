### The filter_modules_in function takes the checklist and radio buttons from the center_nav_bar and returns a list of all modules that match the given filters.
