...
df.loc["bash_103_combining_commands", "learning_objectives"] = "&After completion of this module, learners will be able to:&&- Write the output of a command to a file using `>` and `>>`&- Chain commands directly using the pipe `|`&" 
...
df.loc["data_management_basics", "data_task"] = "data_management"
...
df.loc["database_normalization", "data_task"] = "data_management"
...
df.loc["git_intro", "learning_objectives"] = "&After completion of this module, learners will be able to:&&- Understand the benefits of an automated version control system&- Understand the basics of how automated version control systems work&&" 
...
df.loc["python_basics_writing_python_code", "learning_objectives"] = "&After completion of this module, learners will be able to:&&- Identify and use functions and methods&- Assign values to variables&- Create and edit lists&- Iterate through lists using loops&- Utilize conditional statements&- Create and edit dictionaries&&" 
...
df.loc["python_practice", "coding_level"] = "practice_exercise"
...
df.loc["tidy_data", "data_task"] = "data_management"
