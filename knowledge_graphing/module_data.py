...
df.loc["bash_103_combining_commands", "time"] = "30 minutes" 
...
df.loc["bash_command_line_101", "time"] = "40 minutes" 
...
df.loc["bash_command_line_102", "time"] = "30 minutes" 
...
df.loc["bash_conditionals_loops", "time"] = "1 hour" 
...
df.loc["bash_scripts", "time"] = "1 hour" 
...
df.loc["citizen_science", "time"] = "45 minutes" 
...
df.loc["data_management_basics", "time"] = "40 minutes" 
...
df.loc["data_storage_models", "time"] = "" 
...
df.loc["data_visualization_in_ggplot2", "time"] = "60 min" 
...
df.loc["data_visualization_in_open_source_software", "time"] = "20 minutes" 
...
df.loc["data_visualization_in_seaborn", "time"] = "1 hour" 
...
df.loc["database_normalization", "time"] = "40 minutes" 
...
df.loc["demystifying_geospatial_data", "time"] = "15 minutes" 
...
df.loc["demystifying_python", "time"] = "20m" 
...
df.loc["demystifying_sql", "time"] = "40 minutes" 
...
df.loc["directories_and_file_paths", "time"] = "15m" 
...
df.loc["elements_of_maps", "time"] = "45 minutes" 
...
df.loc["geocode_lat_long", "time"] = "15 minutes" 
...
df.loc["git_creation_and_tracking", "time"] = "1 hour" 
...
df.loc["git_history_of_project", "time"] = "30 minutes" 
...
df.loc["git_setup_mac_and_linux", "time"] = "15 min" 
...
df.loc["git_setup_windows", "time"] = "25 min" 
...
df.loc["how_to_troubleshoot", "time"] = "30 minutes" 
...
df.loc["learning_to_learn", "time"] = "20 minutes" 
...
df.loc["omics_orientation", "time"] = "15m" 
...
df.loc["pandas_transform", "time"] = "1 hour" 
...
df.loc["python_basics_writing_python_code", "time"] = "1 hour" 
...
df.loc["python_practice", "time"] = "1 hour" 
...
df.loc["r_basics_introduction", "time"] = "1 hour" 
...
df.loc["r_basics_transform_data", "time"] = "1 hour" 
...
df.loc["r_basics_visualize_data", "time"] = "1 hour" 
...
df.loc["r_missing_values", "time"] = "45 min" 
...
df.loc["r_reshape_long_wide", "time"] = "1 hour" 
...
df.loc["reproducibility", "time"] = "1 hour" 
...
df.loc["sql_intermediate", "time"] = "1 hour" 
...
df.loc["statistical_tests", "time"] = "20 minutes (although reading through the linked tutorials may take much longer, depending on which tests you choose to read about)" 
...
df.loc["tidy_data", "time"] = "45 minutes" 
...
df.loc["using_redcap_api", "time"] = "1 hour" 
