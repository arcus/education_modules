...
First, let's look at some histograms using `ggplot2`.
...
In the heat map above, dark blue indicates a highly positive correlation, while dark red indicates a strongly negative correlation. Notice anything interesting? Perhaps this can help you develop a hypothesis and you can test later!
