...
1. The importance of accurate data annotation
2. The steps to be taken pre-, during-, and post-annotation for the annotated dataset to be considered gold-standard
3. How you can contribute to maximizing CHOP's return on investment for this work and help accelerate AI and Machine Learning research across the organization